...
#    Updated: 2022/11/04 13:42:27 by rrouille         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

SRCS        = ft_isalpha.c ft_isdigit.c ft_isalnum.c ft_isascii.c ft_isprint.c \
			  ft_memchr.c ft_memset.c ft_memcmp.c ft_memcpy.c ft_memmove.c \
			  ft_strchr.c ft_strrchr.c ft_strncmp.c ft_strlen.c ft_strnstr.c ft_strlcpy.c ft_strlcat.c ft_strdup.c \
...
#SRCS_MINE	= ft_memalloc.c
OBJS		= ${SRCS:.c=.o}
OBJS_BONUS	= ${SRCS_BONUS:.c=.o}
#OBJS_MINE	= ${SRCS_MINE:.c=.o}
NAME		= libft.a
CC			= gcc
...
#mine:		${OBJS} ${OBJS_BONUS} ${OBJS_MINE}
#			ar rcs ${NAME} ${OBJS_BONUS} ${OBJS_MINE}
